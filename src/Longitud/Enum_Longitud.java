...
public enum Enum_Longitud {
    ...
    public static void ConvertirLongitud(String valorBase, double vTotal, String valorTarget){
            DecimalFormat twoPlaces = new DecimalFormat("0.00");
            
            Enum_Longitud enumValue = Enum_Longitud.valueOf(Enum_Longitud.class, comboBoxValues().get(valorBase).toString());
            
            System.out.println("Base: " + enumValue.atomicWeight);
            if(enumValue.atomicWeight > 1)
            {
                
            }
            else if (enumValue.atomicWeight < 1)
            {
            ...
            JOptionPane.showMessageDialog(null, twoPlaces.format(vTotal) + " " + valorBase + "\n = \n " + twoPlaces.format(enumValue.atomicWeight)+ " " + valorTarget, "LONGITUD",
